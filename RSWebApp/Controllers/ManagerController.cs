...
namespace RSWebApp.Controllers
{
    ...
    //                                                     dal
    //                                                     את כל רשומות הטבלה המקשרת לטפסים, של מזכיר מסויים
    ...
    //}
    //[HttpPost("{uid}")]
    //public async Task PostNewSigner([FromBody] SignerDTO signerDTO, int UId)//שמירת לקוח חדש למשתמש - שימוש ב: מיפוי dto
    //{
    ...
    //גם אלו פונקציות מיותרות לכאורה, ומבחינת הצגה ניתן לבצע סינון בצד לקוח
